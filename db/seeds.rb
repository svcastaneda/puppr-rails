...
sitter = User.create(first_name: "Adriana", last_name: "Castaneda", email: "adriana@gmail.com", username: "adriana", password: "password", birthday: "1992-07-23", xp_years: 14, housing_type: "apartment", sitter: true, city: "Chicago", state: "IL", country: "USA", zip_code: "60606")
